    ...
    class Conectar{
        ...
        protected function Conexion(){
            try {
				...
				$conectar = $this->dbh = new PDO("mysql:local=localhost;dbname=diplomasycertificados","root","");
                /*TODO: Cadena de Conexion Produccion*/
				//$conectar = $this->dbh = new PDO("mysql:local=localhost;dbname=diplomasycertificados","user","pass");
				return $conectar;
			} catch (Exception $e) {
        ...
        public static function ruta(){
            //QA
            return "http://localhost/sistemas/GenerarCertificadosyDiplomas/";
            //Produccion
            //return "http://";
        }
