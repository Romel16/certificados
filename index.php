...
<html lang="en">
  <head>
    ...
    <title>Bienvenido a la Empresa de entrega de critificados</title>
  ...
  <body>
    ...
    <div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
      ...
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
        ...
        <div class="tx-center mg-b-60">El adminsitrador</div>
        ...
        <div class="form-group">
          ...
          <a href="" class="tx-info tx-12 d-block mg-t-10">Recordar Contraseña?</a>
        </div><!-- form-group -->
        <button type="submit" class="btn btn-info btn-block">Acceder</button>

        <div class="mg-t-60 tx-center">¿No tienes cuenta? <a href="" class="tx-info">Registarse</a></div>
      </div><!-- login-wrapper -->
    </div><!-- d-flex -->
