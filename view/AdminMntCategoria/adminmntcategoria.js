...
function editar(cat_id){
    $.post("../../controllers/categoriaControllers.php?op=mostrar",{categoriaId : cat_id}, function (data) {
...
function eliminar(cat_id){
    swal.fire({
        ...
        if (result.value) {
            $.post("../../controllers/categoriaControllers.php?op=eliminar",{categoriaId : cat_id}, function (data) {
                $('#categoria_data').DataTable().ajax.reload();
