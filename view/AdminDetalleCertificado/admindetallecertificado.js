    ...
    $('#cur_id').change(function() {
        $("#cur_id option:selected").each(function () {
            ...
            $('#detalle_data').DataTable({
                ...
                "ajax":{
                    url:"../../controllers/usuarioControllers.php?op=listar_cursos_usuario",
                    type:"post",
                    data:{cur_id:cur_id},
                },
                "bDestroy": true,
...
function eliminar(curd_id){
    swal.fire({
        ...
        if (result.value) {
            $.post("../../controllers/cursoControllers.php?op=eliminar_curso_usuario",{detallecursoId : curd_id}, function (data) {
...
function combo_curso(){
    $.post("../../controllers/cursoControllers.php?op=combo", function (data) {
        $('#cur_id').html(data);
    });
}
...
function listar_usuario(cur_id){
    $('#usuario_data').DataTable({
        ...
        "ajax":{
            url:"../../controllers/usuarioControllers.php?op=listar_detalle_usuario",
            type:"post",
            data:{cursoId:cur_id}
        },
        "bDestroy": true,
...
function registrardetalle(){
    ...
    if (usu_id == 0){
        ...
        $.ajax({
            url: "../../controllers/cursoControllers.php?op=insert_curso_usuario",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
